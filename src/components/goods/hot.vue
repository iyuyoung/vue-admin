      ...
      <div class="card">
        <div class="card-header">
          <el-breadcrumb>
            ...
            <el-breadcrumb-item>抢购列表</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        <!--搜索-->
        <div class="search"
        ...
        <el-dialog title="添加到抢购"
                   :visible.sync="layer.add"
                   :append-to-body="isBody">
          <el-button type="primary"
                     icon="el-icon-edit"
                     @click="createGoods">添加到抢购</el-button>
          <div class="search"
               style="display:flex">
            <el-input placeholder="请输入商品标题"
                      v-model="goodsTitle"
...
export default {
  ...
  methods: {
    async _getData () {
      let res = await getData(`/goods/index?page=${this.page}&title=${this.title}&hot=1`, '')
